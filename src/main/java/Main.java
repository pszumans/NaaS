...
//            System.out.println(p);
    ...
    private static void test3() throws IOException, IloException {

        new SolverOPL();
//        Parser p = new Parser("C:\\Users\\Szuman\\Desktop\\NF\\Nowy folder\\NaaS\\long #1 - good\\NaaS.dat");
//
//
//        for (int i = 0; i < 3; i++) {
//            if (i == 1)
//                p = new Parser("C:\\Users\\Szuman\\Desktop\\NF\\Nowy folder\\NaaS\\long #2 - good\\NaaS.dat");
//            else if (i == 2)
//Parser                p = new Parser("C:\\Users\\Szuman\\Desktop\\NF\\Nowy folder\\NaaS\\long #3 - good but long\\NaaS.dat");
//            p.parse();
//            Network n = p.getGraph();
//            Writer w = new Writer("C:\\Users\\Szuman\\Desktop\\NaaS.dat", true);
//            n.setPaths();
//            w.writeData(n);
//            new WriterOPL("C:\\Users\\Szuman\\Desktop\\data"+i+".dat",n).writeOPL();
//            long startTime = System.nanoTime();
//            n.serveRequests();
//            long endTime = System.nanoTime();
//            long duration = (endTime - startTime);
//            n.getRequests().forEach(r -> System.out.print(r.isServed() + " "));
//            System.out.println(n.getUsedCapacity());
...
//        List<String> a = Arrays.asList("ta", "ta");
