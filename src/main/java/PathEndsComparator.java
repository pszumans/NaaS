...
//        return one + two;
        int one = network.getLocations().get(p1.getSource().getLocation()) + (network.getLocations().get(p1.getTarget().getLocation()));
        int two = network.getLocations().get(p2.getSource().getLocation()) + (network.getLocations().get(p2.getTarget().getLocation()));
